...
class DeepSeekHarnessTests(unittest.TestCase):
    ...
    def test_responses_prompt_keeps_codex_as_tool_executor(self) -> None:
        ...
        self.assertIn("prefer multiple apply_patch calls split at complete semantic boundaries", prompt)
        self.assertIn("Do not split merely to satisfy an arbitrary character limit", prompt)
