...
def _tool_format_requirements() -> str:
    return (
        ...
        "For large Markdown, source-code, or other text edits, prefer multiple apply_patch calls split at complete semantic boundaries such as sections, functions, or modules. "
        "Do not split merely to satisfy an arbitrary character limit, and do not sacrifice coherence, completeness, or consistency just to make a patch shorter.\n"
