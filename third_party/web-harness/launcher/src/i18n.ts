...
const en = {
  ...
  biggerContextRecommendationBody: "Experimental multipart transport raises the advertised Codex limits, not the underlying model capacity. Successful delivery does not guarantee retention: earlier parts may be lost. Keep disabled for important work. Extra requests may also trigger rate limits or cooldowns.",
  ...
  reinstall: "Reinstall",
  bridgeStepRuntime: "WebHarness runtime",
  bridgeStepRuntimeBody: "Start the isolated local runtime. Browser AI Bridge already owns the unified Codex model catalog, so Codex is not modified or restarted.",
  bridgeStart: "Start runtime",
  bridgeRestart: "Restart runtime",
...
const zh: Record<keyof typeof en, string> = {
  ...
  biggerContextRecommendationBody: "实验性分段传输只提高向 Codex 声明的阈值，不会扩大模型本身的容量。发送成功不代表完整记住，较早分段的信息可能丢失。重要任务建议保持关闭；额外请求也可能触发限流或冷却。",
  ...
  install: "安装模型",
  reinstall: "重新安装",
  bridgeStepRuntime: "WebHarness 运行时",
  bridgeStepRuntimeBody: "启动隔离的本地运行时。统一 Codex 模型目录由 Browser AI Bridge 管理，不会修改或要求重启 Codex。",
  bridgeStart: "启动运行时",
  bridgeRestart: "重启运行时",
...
const ja: Record<keyof typeof en, string> = {
  ...
  biggerContextRecommendationBody: "実験的な分割転送は Codex に通知する上限を引き上げますが、モデル自体の容量は増えません。送信成功は内容の保持を保証せず、前の部分が失われる場合があります。重要な作業では無効のままにしてください。追加の要求でレート制限が発生する場合もあります。",
  ...
  install: "モデルをインストール",
  reinstall: "再インストール",
  bridgeStepRuntime: "WebHarness ランタイム",
  bridgeStepRuntimeBody: "分離されたローカルランタイムを起動します。Codex の統合モデルカタログは Browser AI Bridge が管理するため、Codex の変更や再起動は不要です。",
  bridgeStart: "ランタイムを起動",
  bridgeRestart: "ランタイムを再起動",
